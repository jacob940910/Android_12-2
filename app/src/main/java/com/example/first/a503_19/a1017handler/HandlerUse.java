package com.example.first.a503_19.a1017handler;
...
*/
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(HandlerUse.this)
                        .setTitle("다운로드")
                        .setMessage("다운로드하시겟습니까?")
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                value = 0;
                                progressDialog = new ProgressDialog(HandlerUse.this);
